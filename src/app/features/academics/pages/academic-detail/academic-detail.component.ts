...
@Component({
  ...
  template: `
    <div class="page-container">
      ...
      <div *ngIf="academic" class="pinterest-panel p-8">
        <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div class="md:col-span-2">
            <div class="mb-6">
              ...
              <div *ngIf="academic.theme" class="flex items-center gap-4 mb-4">
          ...
          <div class="bg-[var(--surface-alt)] border border-[var(--border-light)] p-6 rounded-2xl h-fit">
            ...
            <div class="space-y-3 text-sm">
              ...
              <div>
                ...
                <span class="text-[var(--text-muted)]">{{ academic.publishedAt | date:'longDate':'':'fr-FR' }}</span>
              </div>
            </div>
          </div>
        </div>
